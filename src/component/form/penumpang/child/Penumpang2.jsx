      ...
      getData = () => {
        if(this.props.id !== undefined){
          ...
          axios.get(url).then((res)=>{
            if(res.data.penumpang2 !== ""){
              this.setState({...res.data.penumpang2});
            }
          },
          (err)=>{
            console.log("err");
        ...
        return(
                <div className="penumpang">
                  <div className="d-flex mb-2">
                    ...
                    <div className="col-9 panel-lblue"><b className="uppercase pr-1" >penumpang 2</b>/<span className="font-italic" > passenger 2</span></div>
                  </div>
                  <div className="tbl-1">
